...
func ShowInviteRegister(env *environment.State, route environment.Route) gin.HandlerFunc {
...
func SubmitInviteRegister(env *environment.State, route environment.Route) gin.HandlerFunc {
  fn := func(c *gin.Context) {
